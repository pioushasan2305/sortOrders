...
if __name__ == "__main__":
    ...
    with open(input_csv, mode='r', newline='', encoding='utf-8') as file:
        ...
        for row in csv_reader:
            ...
            sorted_orders_max_inter_class,total_time_taken_to_sort =sort_orders_based_on_best_first_and_static_fields(order_max_inter_class_copy, t ,method_summary ,module ,best_first_index, pairs_superset)
