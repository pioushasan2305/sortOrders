...
import copy
import time
def sort_orders_based_on_inter_class_pairs(orders, t):
    ...
    while orders:
        ...
        for idx, order in enumerate(orders):
            ...
            if current_interclass_cover > max_interclass_cover or \
               (current_interclass_cover == max_interclass_cover and current_interclass_score > max_interclass_score)or \
               (current_interclass_cover == max_interclass_cover and current_interclass_score == max_interclass_score and current_cover > max_cover):
...
if __name__ == "__main__":
    ...
    sorted_orders_inter_class = sort_orders_based_on_inter_class_pairs(order_max_inter_class_copy, t)
