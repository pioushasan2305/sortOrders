...
import string
import OD_detection
def sort_orders_based_on_cost(orders, t,module,instance_no, github_slug,first_idx):
...
if __name__ == "__main__":
    ...
    with open(input_csv, mode='r', newline='', encoding='utf-8') as file:
        ...
        for row in csv_reader:
            ...
            order_cost_inter_class_copy=copy.deepcopy(distributed_orders)
            sorted_orders_cost_inter_class,total_time_taken_to_sort,sorted_orders_path =sort_orders_based_on_cost(order_cost_inter_class_copy, t ,module,instance_no, github_slug,first_idx)
