    ...
    for current_order in sorted_orders:
        for order in [current_order, current_order[::-1]]:
            ...
            for key, OD in OD_dict.items():
                ...
                if last_element == 1 and OD[1] in unique_od_test_list and OD[1] in order:
                ...
                elif (last_element == 2 and OD[2] in unique_od_test_list) or (last_element == 6 and OD[0] in unique_od_test_list and OD[0] in order):
                    #print(2)
                    ...
                    #print(5555)
                    print(order.index(OD[0]))
                    if all(order.index(OD[0]) < order.index(item) for item in temp_list if item in order):
                        itm="fail"
            ...
            if first_remove_flag ==False:
                return first_removal_order_count, first_removal_order_count ,1
    ...
    with open(input_csv, mode='r', newline='', encoding='utf-8') as file:
        ...
        for row in csv_reader:
            ...
            for i in range(num_shuffle_iterations):
                ...
                if first_removal_order_count == 0:
                    break
