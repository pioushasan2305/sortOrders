...
def sort_orders_based_on_cost(orders, t,module):
    ...
    parent_dir_name = "Cost aware interclass relative input"
    ...
    while orders:
        ...
        for idx, order in enumerate(orders):
            ...
            if (current_interclass_score > max_interclass_score):
                ...
                max_order_index = idx
            elif (current_interclass_score == max_interclass_score):
                tie_break_count += 1
            if(current_interclass_score == max_interclass_score ==0):
                max_interclass_cover = current_interclass_cover
                max_interclass_score= current_interclass_score
                max_order_index = idx
                break
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        ...
        sys.exit(1)
    parent_dir_name = "Cost aware interclass relative input OD"
    parent_dir_path = os.path.join(parent_dir_name)
